        ...
        <main role="main">
            <div id="tabContainer">
                <div id="tabs" role="menu">
                    <ul>
                        <li id="tab1" role="menuitem"><a href=#tabPanel1>Produkt 1</a></li>
                        <li id="tab2" role="menuitem"><a href=#tabPanel2>Produkt 2</a></li>
                        <li id="tab3" role="menuitem"><a href=#tabPanel3>Produkt 3</a></li>
                        <li id="tab4" role="menuitem"><a href=#tabPanel4>Produkt 4</a></li>
                        <li id="tab5" role="menuitem"><a href=#tabPanel5>Produkt 5</a></li>
                    </ul>
                </div>
                <div id="containers">
                    <div id="tabPanel1" role="article">
                        <h2 class="ie">Produkt 1</h2>
                        <a href="../_images/produkt.png" title="Produkt 1"><img src="../_images/produkt.png" role="img" alt="Produkt 1"></a>
                    ...
                    <div id="tabPanel2" role="article">
                        <h2 class="ie">Produkt 2</h2>
                        <a href="../_images/produkt.png" title="Produkt 2"><img src="../_images/produkt.png" role="img" alt="Produkt 2"></a>
                    ...
                    <div id="tabPanel3" role="article">
                        <h2 class="ie">Produkt 3</h2>
                        <a href="../_images/produkt.png" title="Produkt 3"><img src="../_images/produkt.png" role="img" alt="Produkt 3"></a>
                    ...
                    <div id="tabPanel4" role="article">
                        <h2 class="ie">Produkt 4</h2>
                        <a href="../_images/produkt.png" title="Produkt 4"><img src="../_images/produkt.png" role="img" alt="Produkt 4"></a>
                    ...
                    <div id="tabPanel5" role="article">
                        <h2 class="ie">Produkt 5</h2>
                        <a href="../_images/produkt.png" title="Produkt 5"><img src="../_images/produkt.png" role="img" alt="Produkt 5"></a>
